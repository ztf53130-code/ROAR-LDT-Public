...
function exSetUpRoutineBegin(trials) {
  return function () {
    ...
    exSetUpComponents.forEach( function(thisComponent) {
...
function nIncorrectLoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  nIncorrectLoop.forEach(function() {
...
function threeBlocksLoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  threeBlocksLoop.forEach(function() {
...
function blockSelecterLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  blockSelecter.forEach(function() {
...
function incorSoundPlayLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  incorSoundPlay.forEach(function() {
...
function charUnlockDecLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  charUnlockDec.forEach(function() {
...
function InstLoopRoutineBegin(trials) {
  return function () {
    ...
    InstLoopComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function LexBlockRoutineBegin(trials) {
  return function () {
    ...
    LexBlockComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function pCorrectSoundCodeRoutineBegin(trials) {
  return function () {
    ...
    pCorrectSoundCodeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function correctSoundPracRoutineBegin(trials) {
  return function () {
    ...
    correctSoundPracComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function incorrectPracRoutineBegin(trials) {
  return function () {
    ...
    incorrectPracComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function clericUnlockRoutineBegin(trials) {
  return function () {
    ...
    clericUnlockComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function correctSoundCodeRoutineBegin(trials) {
  return function () {
    ...
    correctSoundCodeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function inCorrSoundRoutineBegin(trials) {
  return function () {
    ...
    inCorrSoundComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function blockAnimLoopRoutineBegin(trials) {
  return function () {
    ...
    blockAnimLoopComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function fixateOnCrossRoutineBegin(trials) {
  return function () {
    ...
    fixateOnCrossComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function halfwayBreakRoutineBegin(trials) {
  return function () {
    ...
    halfwayBreakComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function InnInstRoutineBegin(trials) {
  return function () {
    ...
    InnInstComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function charUnlockRoutineBegin(trials) {
  return function () {
    ...
    charUnlockComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function valleyInstRoutineBegin(trials) {
  return function () {
    ...
    valleyInstComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function gameEndRoutineBegin(trials) {
  return function () {
    ...
    gameEndComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function CreditsRoutineBegin(trials) {
  return function () {
    ...
    CreditsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
